<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Instances.ascx.cs" Inherits="FergusonMoriyam.Workflow.Umbraco.Web.Ui.Instances" %>
<%@ Import Namespace="FergusonMoriyam.Workflow.Interfaces.Domain" %>
<%@ Import Namespace="FergusonMoriyam.Workflow.Umbraco.Domain" %>
