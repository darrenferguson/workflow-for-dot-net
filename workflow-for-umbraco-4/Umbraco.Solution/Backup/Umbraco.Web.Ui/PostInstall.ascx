...
<asp:Panel ID="InstallDonePanel" runat="server" Visible="false">
    ...
    <p>
        If you have any questions regarding Workflow for Umbraco please <a href="http://www.moriya.ma/contact" target="_blank">contact Moriya.ma</a>.
    </p>
</asp:Panel>
...
<asp:Panel ID="InstallerErrorPanel" runat="server" Visible="false">
    ...
    <asp:Button ID="ManualInstallButton" runat="server" 
        Text="Install (I understand the risks)" onclick="ManualInstallButtonClick" />
