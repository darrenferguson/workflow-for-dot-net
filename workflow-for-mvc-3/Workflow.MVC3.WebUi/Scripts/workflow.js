...
$().ready(function () {
    ...
    $('#submit1').click(function () {
        ...
        $('#taskInfo').val(JSON.stringify(wf.config.UiTasks));
        ...
        $('#transitionInfo').val(JSON.stringify(wf.transitions));
    ...
    $('.design').live('click', function () {
        ...
        $('#propertiesFrame').attr('src', '/WorkflowTaskProperties/Index/' + config['Id'] + '?' + qs);
